...
public class GetUserByEmailTest
{
   private Mock<IHttpContextAccessor> _httpContextAccessor = null!;
    ...
    public async Task GetUserByUserName_ShouldReturnFailure_WhenUserIsNotFound()
    {
        ...
        // Act
        ResponseDto<GetUserDto> result = await this._userService.GetUserByEmail(email);
    ...
    public async Task GetUserByUserName_ShouldReturnValidUserDto_WhenUserIsFound()
    {
        ...
        this._httpContextAccessor.Setup(x => x.HttpContext!.Items["UserId"]).Returns(email);
        this._userManager.Setup(manager => manager.FindByEmailAsync(email)).ReturnsAsync(this._applicationUser);
