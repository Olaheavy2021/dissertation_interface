...
public class GetUserTest
{
    ...
    [Test]
    public async Task GetUser_ShouldReturnInvalidRequest_WhenUserIdIsNull()
    {
        // Arrange
        this._httpContextAccessor.Setup(x => x.HttpContext!.Items["UserId"]).Returns(null!);

        // Act
        ResponseDto<GetUserDto> result = await this._userService.GetUser();
        Assert.Multiple(() =>
        {
    ...
    [Test]
    public void GetUser_ShouldThrowNotFoundException_WhenUserIsNotFound()
    {
        // Arrange
