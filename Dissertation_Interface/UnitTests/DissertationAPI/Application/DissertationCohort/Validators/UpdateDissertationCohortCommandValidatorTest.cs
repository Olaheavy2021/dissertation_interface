...
public class UpdateDissertationCohortCommandValidatorTest
{
    private readonly Mock<IUnitOfWork> _unitOfWork = new();
    private readonly UpdateDissertationCohortCommandValidator _updateDissertationCohortCommandValidator;

    public UpdateDissertationCohortCommandValidatorTest() =>
        this._updateDissertationCohortCommandValidator = new UpdateDissertationCohortCommandValidator(
    ...
    public async Task Should_Not_Have_Error_When_Command_IsValid()
    {
        ...
        UpdateDissertationCohortCommand command = new(request.StartDate, request.EndDate, request.SupervisionChoiceDeadline, request.AcademicYearId,request.AcademicYearId );

        TestValidationResult<UpdateDissertationCohortCommand>? result = await this._updateDissertationCohortCommandValidator.TestValidateAsync(command);
